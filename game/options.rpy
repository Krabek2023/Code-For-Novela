...
define config.name = _("Путь Программиста")
...
## каналах, раскомментируйте строчку и настройте пример звука для прослушивания.
 ...
 #define config.sample_sound = "MAINTHEME.mp3"
...
## игры, если не будет остановлен, или не начнёт проигрываться другой аудиофайл.
 ...
 #define config.main_menu_music = "MAINTHEME.ogg"
...
define config.save_directory = "Test-1695222106"

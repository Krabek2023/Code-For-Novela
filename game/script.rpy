label start:
    ...
    label Entering:
        ...
        All "Уважаемый, Олег Степанович, а как у вас проходила студенческая жизнь, а то у нас ещё и сессия не началась или как она тут называется, а мы уже устали учиться."
